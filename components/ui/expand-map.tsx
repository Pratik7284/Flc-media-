...
export function LocationMap({
  ...
  coordinates = "19.0544° N, 72.9150° E",
  className,
}: LocationMapProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="relative overflow-hidden rounded-2xl bg-[#022c22] border border-white/10 shadow-2xl"
        style={{
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              ...
              <motion.div
                className="absolute top-[40%] left-[10%] w-[15%] h-[20%] rounded-sm bg-emerald-300/10 border border-emerald-300/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.5 }}
              />
              <motion.div
                className="absolute top-[15%] left-[35%] w-[12%] h-[15%] rounded-sm bg-emerald-300/10 border border-emerald-300/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.6 }}
              />
              <motion.div
                className="absolute top-[70%] left-[75%] w-[18%] h-[18%] rounded-sm bg-emerald-300/10 border border-emerald-300/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.7 }}
              />
              <motion.div
                className="absolute top-[20%] right-[10%] w-[10%] h-[25%] rounded-sm bg-emerald-300/10 border border-emerald-300/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.55 }}
              />
              <motion.div
                className="absolute top-[55%] left-[5%] w-[8%] h-[12%] rounded-sm bg-emerald-300/10 border border-emerald-300/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.65 }}
              />
              <motion.div
                className="absolute top-[8%] left-[75%] w-[14%] h-[10%] rounded-sm bg-emerald-300/10 border border-emerald-300/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
              ...
              >
                ...
                >
                  ...
                  <circle cx="12" cy="9" r="2.5" className="fill-[#022c22]" />
                </svg>
              </motion.div>
          ...
          <svg width="100%" height="100%" className="absolute inset-0">
            <defs>
              <pattern id="grid-map" width="20" height="20" patternUnits="userSpaceOnUse">
                <path d="M 20 0 L 0 0 0 20" fill="none" className="stroke-emerald-400" strokeWidth="0.5" />
              </pattern>
            </defs>
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          ...
          <div className="space-y-1">
            ...
            <AnimatePresence>
              {isExpanded && (
                <motion.p
                  className="text-emerald-200/70 text-xs font-mono"
      ...
      {/* Click hint */}
      <motion.p
        className="absolute -bottom-6 left-1/2 text-[10px] text-emerald-400/50 whitespace-nowrap"
        style={{ x: "-50%" }}
        initial={{ opacity: 0 }}
        animate={{
