...
const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    name: 'Anusha Ramani',
    role: 'Founder & CEO',
    image: 'https://i.ibb.co/67znCLBw/Mam.png',
  ...
  },
  {
    ...
    image: 'https://i.ibb.co/qLxZLM5b/Pratik-Tiwari.png',
  ...
  },
  {
    ...
    image: 'https://i.ibb.co/PzGxsDpn/Anuj.png',
  ...
  },
  {
    ...
    name: 'Abrar Khan',
    role: 'Admin & HR ',
    image: 'https://i.ibb.co/hJbbWYkw/Abrar.png',
  ...
  },
  {
    ...
    name: 'Rohit Shah',
    role: 'Operation Head',
    image: 'https://i.ibb.co/zVLJV3Pw/rohit-sir.jpg',
    ...
    <div className="relative min-h-screen text-white selection:bg-[#4ade80] selection:text-black cursor-auto md:cursor-none overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 md:px-8 py-4 bg-transparent">
        ...
        <div className="flex items-center gap-4 z-50 cursor-default">
           <img 
             src="https://i.ibb.co/VYpV9KTm/Logo-Flc.jpg" 
